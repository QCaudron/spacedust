...
class Supernova(object):
    """
    Main deduplicator class. Inherit from this to get supernoving.
    """
    ...
    filename = "supernova/parent_deduplicator"
...
#        "feature_crossing__only_interactions": [True, False],
        ...
        "boosted_forest__n_estimators": [50, 100, 200],
        "boosted_forest__max_depth": [2, 3, 4, 5, 7],
